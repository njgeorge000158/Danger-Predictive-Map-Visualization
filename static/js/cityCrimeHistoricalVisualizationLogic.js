/****************************************************************************
 *
 *  File Name:  cityCrimeHistoricalVisualizationLogic.js
 *
 *  File Description:
 *      This Javascript file contains the function and subroutine calls 
 *      for the html file, cityCrimeHistoricalVisualizationIndex.html. 
...
let gridCrimes2016ActualOverlayLayerGroup
        = L.layerGroup();

let gridCrimes2017ActualOverlayLayerGroup
        = L.layerGroup();
        
let gridCrimes2018ActualOverlayLayerGroup
        = L.layerGroup();
        
let gridCrimes2019ActualOverlayLayerGroup
        = L.layerGroup();

let gridCrimes2020ActualOverlayLayerGroup
        = L.layerGroup();

let gridCrimes2021ActualOverlayLayerGroup
        = L.layerGroup();

let gridCrimes2022ActualOverlayLayerGroup
        = L.layerGroup();
...
const gridCrimesOverlayLayerGroupDictionary 
        = {
                'UCR Crimes (2016)': gridCrimes2016ActualOverlayLayerGroup,
                'UCR Crimes (2017)': gridCrimes2017ActualOverlayLayerGroup,
                'UCR Crimes (2018)': gridCrimes2018ActualOverlayLayerGroup,
                'UCR Crimes (2019)': gridCrimes2019ActualOverlayLayerGroup,
                'UCR Crimes (2020)': gridCrimes2020ActualOverlayLayerGroup,
                'UCR Crimes (2021)': gridCrimes2021ActualOverlayLayerGroup,
                'UCR Crimes (2022)': gridCrimes2022ActualOverlayLayerGroup,
            ...
            (yearString)
{
    ...
    if (yearString == '2016')
    {
        currentOverlayLayerGroup = gridCrimes2016ActualOverlayLayerGroup;

        ucrCrimesList = gridCrimes2016ActualList;
    }
    else if (yearString == '2017')
    {
        currentOverlayLayerGroup = gridCrimes2017ActualOverlayLayerGroup;

        ucrCrimesList = gridCrimes2017ActualList;
    }
    else if (yearString == '2018')
    {
        currentOverlayLayerGroup = gridCrimes2018ActualOverlayLayerGroup;

        ucrCrimesList = gridCrimes2018ActualList;
    }
    else if (yearString == '2019')
    {
        currentOverlayLayerGroup = gridCrimes2019ActualOverlayLayerGroup;

        ucrCrimesList = gridCrimes2019ActualList;
    }
    else if (yearString == '2020')
    {
            ...
            (yearString)
{
    const [currentOverlayLayerGroup, ucrCrimesList] 
            = ReturnUcrCrimesAndOverlayFunction(yearString);
...
function InitializeWebPageSubroutine() 
{
    ...
    DisplayUcrCrimesSubroutine('2016');

    DisplayUcrCrimesSubroutine('2017');

    DisplayUcrCrimesSubroutine('2018');

    DisplayUcrCrimesSubroutine('2019');

    DisplayUcrCrimesSubroutine('2020');

    DisplayUcrCrimesSubroutine('2021');

    DisplayUcrCrimesSubroutine('2022');
