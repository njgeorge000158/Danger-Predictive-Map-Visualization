/****************************************************************************
 *
 *  File Name:  cityCrimePredictiveVisualizationLogic.js
 *
 *  File Description:
...
let gridCrimes2024PredictionsOverlayLayerGroup
        = L.layerGroup();
...
let chloropleth2023PredictionsOverlayLayerGroup
        = L.layerGroup();

let chloropleth2024PredictionsOverlayLayerGroup
        = L.layerGroup();
        
let chloroplethNonePredictionsOverlayLayerGroup
        = L.layerGroup();
...
const gridCrimesOverlayLayerGroupDictionary 
        = {
                ...
                'UCR Predict (2024)': gridCrimes2024PredictionsOverlayLayerGroup,
                'None': gridCrimesNonePredictionsOverlayLayerGroup
          };

const predictiveMapsOverlayLayerGroupDictionary 
        = {
                'Map Predict (2023)': chloropleth2023PredictionsOverlayLayerGroup,
                'Map Predict (2024)': chloropleth2024PredictionsOverlayLayerGroup,
                'None': chloroplethNonePredictionsOverlayLayerGroup
          };
             ...
             chloroplethBoolean = false)
{
    ...
    {
        if (chloroplethBoolean == true)
        {
            currentOverlayLayerGroup = chloropleth2023PredictionsOverlayLayerGroup;
        }
        else
        {
    ...
    else if (yearString == '2024')
    {
        if (chloroplethBoolean == true)
        {
            currentOverlayLayerGroup = chloropleth2024PredictionsOverlayLayerGroup;
        }
        else
        {
...
function InitializeWebPageSubroutine() 
{
    ...
    DisplayUcrCrimesSubroutine('2024');
